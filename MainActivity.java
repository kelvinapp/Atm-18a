...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUET_LOGIN = 100 ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!logon){
            ...
            startActivityForResult(intent , REQUET_LOGIN);
...
//        functions.add(new Function(funcs[1], R.drawable.func_blance));
